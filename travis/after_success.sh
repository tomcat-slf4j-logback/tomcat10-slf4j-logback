...
if [ $TRAVIS_REPO_SLUG == "tomcat-slf4j-logback/tomcat9-slf4j-logback" ] && [ $TRAVIS_PULL_REQUEST == "false" ] && [ $TRAVIS_BRANCH == "master" ] && [[ "$commit_message" != *"[maven-release-plugin]"* ]]; then
